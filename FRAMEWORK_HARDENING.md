...
- **Remaining P0:** SEC-23 (unsigned `unserialize()` of queue/cache), SEC-28..SEC-32 (file/download traversal), SEC-33 (mass-assignment doc). Native-session items get integration coverage after the WRK-08 session rewrite.
- **Test count:** 54 tests / 104 assertions green.
