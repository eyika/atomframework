...
- **P1 remaining:** BUG-31 (static DB rewrite — big), BUG-23 (`first()`→`null` + app audit), ORM architecture (model events, eager-loading), BUG-41 (validator static→worker-safety P4). **Suite: 112 tests / 211 assertions green.**
