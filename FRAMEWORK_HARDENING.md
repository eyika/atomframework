...
- **Remaining P0:** SEC-22..SEC-33 (SSRF/redirect/host/IP, serialization, file/download traversal, mass-assignment doc). Native-session items get integration coverage after the WRK-08 session rewrite.
- **Test count:** 44 tests / 92 assertions green.
