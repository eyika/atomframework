...
- **Next P1:** ORM/DB (BUG-20..36 — incl. model events, N+1, `restore()` corruption, `first()` returns false, dead JOINs), container (BUG-37..40), validation (BUG-41..46), unimplemented API (BUG-47..53), session-handler binds (BUG-54..56).
