...
abstract class TestCase extends PHPUnitTestCase
{
    ...
    /**
     * Bind a lightweight in-memory session double (has/get/set/forget) so tests for
     * session/auth-dependent routes can seed state without a real session backend. Call
     * it before the request; it stays bound until the next boot resets the container.
     */
