 ...
 *
 * @method \Eyika\Atom\Framework\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon createFromDate($year = null, $month = null, $day = null, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon|false createFromFormat($format, $time, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon createFromTimeString($time, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon createFromTimestamp($timestamp, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon createFromTimestampMs($timestamp, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \Eyika\Atom\Framework\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $timezone = null)
 ...
 * @method \Eyika\Atom\Framework\Support\Carbon fromSerialized($value)
 ...
 * @method \Eyika\Atom\Framework\Support\Carbon|null getTestNow()
 ...
 * @method \Eyika\Atom\Framework\Support\Carbon instance($date)
 ...
 * @method \Eyika\Atom\Framework\Support\Carbon|null make($var)
 * @method \Eyika\Atom\Framework\Support\Carbon maxValue()
 * @method \Eyika\Atom\Framework\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Eyika\Atom\Framework\Support\Carbon now($timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon parse($time = null, $timezone = null)
 ...
 * @method \Eyika\Atom\Framework\Support\Carbon today($timezone = null)
 * @method \Eyika\Atom\Framework\Support\Carbon tomorrow($timezone = null)
 ...
 * @method \Eyika\Atom\Framework\Support\Carbon yesterday($timezone = null)
 */
class DateFactory
{
    /**
